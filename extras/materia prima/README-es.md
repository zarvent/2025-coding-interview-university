...
Estoy agregando estos para redondear para que seas un ingeniero de software completo, y para estar al tanto de ciertas
...
- ### Sistemas de mensajería, serialización y colas
  ...
  - [Amazon SQS (cola)](https://aws.amazon.com/sqs/)
...
- ### Filtro Bloom
  ...
  - Dado un filtro bloom con m bits y k hashing functions, tanto insertion como membership testing son O(k)
  - [Bloom Filters (video)](https://www.youtube.com/watch?v=-SuTGoFYjZs)
  - [Bloom Filters | Mining of Massive Datasets | Stanford University (video)](https://www.youtube.com/watch?v=qBTdukbzcA78)
...
- ### Locality-Sensitive Hashing
  ...
  - Usado para determinar la similitud de documentos
  - Lo opuesto de MD5 o SHA que se usan para determinar si 2 documentos/strings son exactamente iguales
...
- ### Árboles de búsqueda balanceados
  ...
  - Conoce al menos un tipo de árbol binario balanceado (y conoce cómo se implementa):
  - "Entre los árboles de búsqueda balanceados, AVL y 2/3 trees están ahora passé, y red-black trees parecen ser más populares.
        Una estructura de datos autoorganizante particularmente interesante es el splay tree, que usa rotaciones
        para mover cualquier key accedida hacia la raíz." - Skiena
  - De estos, elegí implementar un splay tree. De lo que he leído, no implementarás un
        árbol de búsqueda balanceado en tu entrevista. Pero quería exposición al conjunto de codificación
        y seamos honestos, splay trees son la rodilla de la abeja. Leí mucho código de red-black tree
    - Splay tree: insertar, buscar, eliminar funciones
        Si terminas implementando red/black tree intenta solo estos:
    - Funciones de búsqueda e inserción, omitiendo eliminar
  - Quiero aprender más sobre B-Tree ya que se usa tan ampliamente con bases de datos muy grandes
  - [Self-balancing binary search tree](https://en.wikipedia.org/wiki/Self-balancing_binary_search_tree)

  - **AVL trees**
    - En práctica:
            Desde lo que puedo decir, estos no se usan mucho en práctica, pero podría ver donde serían:
            AVL tree es otra estructura que soporta O(log n) búsqueda, inserción, y eliminación. Es más
            rígidamente balanceado que red-black trees, llevando a inserción y eliminación más lenta pero
            búsqueda más rápida. Esto lo hace atractivo para estructuras de datos que pueden ser construidas una vez
            y cargadas sin reconstrucción, como diccionarios de lenguaje (o diccionarios de programa, como
            los opcodes de un ensamblador o intérprete)
  ...
  - **Splay trees**
    - En práctica:
            Splay trees son típicamente usados en implementación de caches, allocators de memoria, routers, garbage collectors,
            compresión de datos, ropes (replacement de string usado para texto largo), en Windows NT (en virtual memory,
            networking, y file system code) etc
  ...
  - **Red/black trees**
    - Estos son una traducción de un 2-3 tree (ver abajo)
    - En práctica:
            Red-black trees ofrecen garantías worst-case para tiempo de inserción, tiempo de eliminación, y tiempo de búsqueda.
            Esto no solo los hace valiosos en aplicaciones time-sensitive como aplicaciones real-time, sino que los hace
            valiosos building blocks en otras estructuras de datos que proveen garantías worst-case; por ejemplo,
            muchas estructuras de datos usadas en computational geometry pueden ser basadas en red-black trees, y
            Completely Fair Scheduler usado en kernels Linux actuales usa red-black trees. En la versión 8 de Java,
            HashMap Collection ha sido modificado tal que en lugar de usar una LinkedList para almacenar elementos idénticos con hash codes pobres, un Red-Black tree es usado
    - [Aduni - Algorithms - Lecture 4 (enlace va al punto inicial) (video)](https://youtu.be/1W3x0f_RmUo?list=PLFDnELG9dpVxQCxuD-9BSy2E7BWY3t5Sm&t=3871)
  ...
  - **2-3 search trees**
    - En práctica:
            2-3 trees tienen inserción más rápida a expensas de búsquedas más lentas (ya que altura es más en comparación a AVL trees).
    - Usarías 2-3 tree muy raramente porque su implementación involucra diferentes tipos de nodos. En lugar, la gente usa Red Black trees.
  ...
  - **2-3-4 Trees (aka 2-4 trees)**
    - En práctica:
            Por cada 2-4 tree, hay red-black trees correspondientes con los mismos elementos de datos en el mismo orden. Operaciones de inserción y eliminación
            en 2-4 trees también son equivalentes a color-flipping y rotations en red-black trees. Esto hace que 2-4 trees sean una
            herramienta importante para entender la lógica detrás red-black trees, y es por eso que muchos introductory algorithm textbooks introducen
            2-4 trees justo antes red-black trees, aunque **2-4 trees no se usan a menudo en la práctica**.
    - [CS 61B Lecture 26: Balanced Search Trees (video)](https://archive.org/details/ucberkeley_webcast_zqrqYXkth6Q)
    - [Bottom Up 234-Trees (video)](https://www.youtube.com/watch?v=DQdMYevEyE4&index=4&list=PLA5Lqm4uh9Bbq-E0ZnqTIa8LRaL77ica6)
    - [Top Down 234-Trees (video)](https://www.youtube.com/watch?v=2679VQ26Fp4&list=PLA5Lqm4uh9Bbq-E0ZnqTIa8LRaL77ica6&index=5)

  - **N-ary (K-ary, M-ary) trees**
    - nota: N o K es el branching factor (max branches)
    - binary trees son un 2-ary tree, con branching factor = 2
    - 2-3 trees son 3-ary
    - [K-Ary Tree](https://en.wikipedia.org/wiki/K-ary_tree)

  - **B-Trees**
    - Dato divertido: es un misterio, pero B podría representar Boeing, Balanced, o Bayer (co-inventor)
    - En práctica:
            B-Trees son ampliamente usados en bases de datos. La mayoría de sistemas de archivos modernos usan B-trees (o Variants).
            Además de su uso en bases de datos, B-tree también es usado en file systems para permitir acceso rápido aleatorio a un
            bloque arbitrario en un archivo particular. El problema básico es convertir file block i address a disco block
            (o quizás a cylinder-head-sector) address
    ...
    - [MIT 6.851 - Memory Hierarchy Models (video)](https://www.youtube.com/watch?v=V3omVLzI0WE&index=7&list=PLUl4u3cNGP61hsJNdULdudlRL493b-XZf)
                - cubre cache-oblivious B-Trees, very interesting data structures
                - las primeras 37 minutos son muy técnicos, pueden omitirse (B es block size, cache line size)
    - [[Review] B-Trees (playlist) in 26 minutes (video)](https://www.youtube.com/playlist?list=PL9xmBV_5YoZNFPPv98DjTdD9X6UI9KMHz)

- ### k-D Trees

  - Genial para encontrar número de puntos en un rectángulo o objeto higher dimensional
  - Un buen ajuste para k-nearest neighbors
  - [kNN K-d tree algorithm (video)](https://www.youtube.com/watch?v=Y4ZgLlDfKDg)

- ### Skip lists

  - "Estos son un poco de un culto data structure" - Skiena
...
- ### Treap
  ...
  - Combination de un binary search tree y un heap
...
- **Más Programación Dinámica** (videos)
...
- **Procesamiento Avanzado de Grafos** (videos)
  - [Synchronous Distributed Algorithms: Symmetry-Breaking. Shortest-Paths Spanning Trees](https://www.youtube.com/watch?v=mUBmcbbJNf4&list=PLUl4u3cNGP6317WaSNfmCvGym2ucw3oGp&index=27)
  - [Asynchronous Distributed Algorithms: Shortest-Paths Spanning Trees](https://www.youtube.com/watch?v=kQ-UQAzcnzA&list=PLUl4u3cNGP6317WaSNfmCvGym2ucw3oGp&index=28)

- MIT **Probabilidad** (matemáticas, y ve despacio, lo cual es bueno para cosas matemáticas) (videos):
...
- **Coincidencia de Cadenas**
  ...
  - [Coursera: Algorithms on Strings](https://www.coursera.org/learn/algorithms-on-strings/home/week/1)
    - comienza muy bien, pero para cuando pasa KMP se vuelve más complicado de lo necesario
    - buena explicación de tries
    - se puede omitir
...
- **Ordenamiento**
  ...
  - Stanford lectures on sorting:
    ...
    - [Lecture 16 | Programming Abstractions (video)](https://www.youtube.com/watch?v=y4MM9IVgrVKo&index=16&list=PLFE6E58F856038C69)
  - Shai Simonson:
...
- [2004: MapReduce: Simplified Data Processing on Large Clusters]( http://static.googleusercontent.com/media/research.google.com/en//archive/mapreduce-osdi04.pdf)
  - ¿reemplazado principalmente por Cloud Dataflow?
